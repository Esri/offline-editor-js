		...
		esriConfig,GraphicsLayer,Graphic,SimpleMarkerSymbol,SimpleLineSymbol,SimpleFillSymbol,urlUtils)
{
    ...
    return declare("O.esri.Edit.OfflineFeaturesManager",[Evented],
    {
            ...
            */            
            ...
            layer.applyEdits = function(adds,updates,deletes,callback,errback)
            {
                ...
                adds.forEach(function(addEdit)
                {
                    ...
                    //   console.log("Phantom graphic " + objectId + " added to database.");
                    //});
        ...
        /**
         * Only delete phantom graphics from database that correspond to successfully deleted edits.
         * If there was a problem we want to leave the phantom graphic.
         * @param responses Object
         * @param callback
         * @private
         */
        _cleanPhantomGraphicsRecords: function(responses,callback){
