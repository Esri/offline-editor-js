		...
		GraphicsLayer,Graphic,SimpleMarkerSymbol,SimpleLineSymbol,SimpleFillSymbol,urlUtils)
{
    return declare([Evented],
    {
        ...
        _uploadAttachment: function(attachment)
        {
            ...
            var proxy = urlUtils.getProxyUrl(attachment.featureId); //esriConfig.defaults.io.proxyUrl;
            oAjaxReq.open("post", proxy.path + "?" + attachment.featureId + "/addAttachment", true);
