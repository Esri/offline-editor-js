...
define([
	...
	"dojo/_base/lang",
	"esri/request"],
	function(editsStore,Evented,Deferred,all,declare,lang,esriRequest)
{
			...
			layer.applyEdits = function(adds,updates,deletes,callback,errback)
			{
				...
				else
				{
					...
					deletes.forEach(function(deleteEdit)
					{
						...
						results.deleteResults.push({success:result.success, error: result.error, objectId: deleteEdit.attributes[ this.objectIdField ]});
					},this);
