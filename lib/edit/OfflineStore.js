...
var OfflineStore = function(/* Map */ map) {
            ...
            for(var i = 0; i < length; i++){
                ...
                this._layerEditManager(obj1.graphic,layer,obj1.enumValue,this.enum(),i,function(/* Number */ num, /* boolean */ success, /* String */ id,error){
                    ...
                    if(success == true && check.length == graphicsArr.length){
                        if(errCnt == 0){
                            this._setItemLocalStoreIndex(obj1.layer,id,obj1.enumValue,true,obj1.graphic.geometry.type);
                    ...
                    //Don't return anything yet
                        ...
                        this._setItemLocalStoreIndex(obj1.layer,id,obj1.enumValue,false, obj1.graphic.geometry.type);
     ...
     * either successful or unsuccessful. Listen for update events via indexUpdateEvent.
     * @param layerId
     * @param objectId
     * @param enumType enum
     * @param success
     * @oaran geomType The string representation of the geometry type
     * @returns {boolean}
     * @private
     */
    this._setItemLocalStoreIndex = function(/* String */ layerId, /* String */ objectId, /* String */ enumType,
        /* boolean */ success, /* String */ geomType){
        var index = new this._indexObject(layerId,objectId,enumType,success,geomType) ;
        ...
        try{
            ...
            this._sendEvent(index,this._localEnum().INDEX_UPDATE_EVENT);
        }
        catch(err){
