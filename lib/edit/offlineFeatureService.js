			...
			layer.applyEdits = function(adds,updates,deletes,callback,errback)
			{
				...
				else
				{
					...
					adds.forEach(function(addEdit)
					{
						...
						editsStore.pushEdit(editsStore.ADD, layer.url, addEdit);
					...
					{
						editsStore.pushEdit(editsStore.UPDATE, layer.url, updateEdit);
					...
					{
						editsStore.pushEdit(editsStore.DELETE, layer.url, deleteEdit);
