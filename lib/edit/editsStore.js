...
O.esri.Edit.EditStore = function()
{
     ...
     * a FeatureLayer.
     *
     * Handles both adds and updates. It copies any object properties, so it will overwrite the entire object.
     *
     * Example: If you just submit {featureLayerRenderer: {someJSON}}
     *
    ...
    this.deleteFeatureLayerData = function(callback){
