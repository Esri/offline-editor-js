...
//                    var promise = request.get(layer._tileUrlArr[0], {
...
//                    var pixels = tileInfo.height * tileInfo.width;
//                    var bytesPerPixel = 0;
//                    var compressionFactor = 1 - (tileInfo.compressionQuality / 100);
//                    switch(tileInfo.format.toLocaleLowerCase()){
//                        case "jpeg":
//                            bytesPerPixel = 1.4;
//                            break;
//                        case "png8":
...
//                    }
					...
					//return size; // TODO - come up with a more precise estimation method
				};
